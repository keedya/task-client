...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OnTaskClient.PostTasks();
  });
  ...
  describe('PostTasks', function() {
    it('should create an instance of PostTasks', function() {
      // uncomment below and update the code to test PostTasks
      //var instane = new OnTaskClient.PostTasks();
      //expect(instance).to.be.a(OnTaskClient.PostTasks);
    });
