...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.OnTaskClient.Action = factory(root.OnTaskClient.ApiClient);
  }
   ...
   * @class
   * @param command {module:model/Action.CommandEnum} Command to execute
   */
  ...
  /**
   * Command to execute
   * @member {module:model/Action.CommandEnum} command
   */
